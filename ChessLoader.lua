...
if game.PlaceId == 1268288957 then
    ...
    loadstring(game:HttpGet("https://raw.githubusercontent.com/AutomatingLife/krnlautochessapi/main/TuningStudiosChess.lua"))()
elseif game.PlaceId == 6222531507 then
    print("Loading cookie chess script!")
    loadstring(game:HttpGet("https://raw.githubusercontent.com/AutomatingLife/krnlautochessapi/main/CookieChess.lua"))()
else
    error("Invalid game!")
end
